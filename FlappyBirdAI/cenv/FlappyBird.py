...
def main(genomas, config): 
    ...
    lista_genomas = []  # Inicializar lista_genomas aqui
    if ai_jogando:
        redes = []
        passaros = []
        for _, genoma in genomas:
            ...
            redes.append(rede)
            genoma.fitness = 0
            lista_genomas.append(genoma)  # Adicionar genoma à lista_genomas
...
if __name__ == '__main__':
    ...
    caminho_config = os.path.join('D:\Dados\Programação Projetos\Python\Flappy Bird IA\cenv\Configuracao da Inteligencia Artificial [Projeto Flappy Bird - Aula 3 de 4].txt')
